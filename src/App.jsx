...
function LoadingScreen() {
  return (
    <div style={{
      ...
      background: 'linear-gradient(135deg, #1a2a0a, #2d4a1a)',
      display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
      color: '#fff', fontFamily: "'Inter', system-ui, sans-serif", zIndex: 999,
    }}>
      <div style={{ fontSize: '64px', marginBottom: '16px' }}>🍂</div>
      <div style={{ fontSize: '30px', fontWeight: 900, letterSpacing: '3px', marginBottom: '8px' }}>LEAF IT ALONE</div>
      <div style={{ color: 'rgba(255,255,255,0.55)', fontSize: '15px' }}>Building the garden...</div>
    </div>
  );
}
...
function ClickToPlay() {
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: '32px', fontWeight: 900, letterSpacing: '3px', marginBottom: '6px' }}>LEAF IT ALONE</div>
      <div style={{ color: 'rgba(255,255,255,0.55)', fontSize: '15px', marginBottom: '28px' }}>A peaceful autumn garden</div>

      <div style={{
        background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.22)',
        borderRadius: '16px', padding: '22px 38px', textAlign: 'center', maxWidth: '400px',
      }}>
        <div style={{ fontSize: '19px', fontWeight: 700, marginBottom: '16px' }}>🖱️ Click anywhere to start</div>
        <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.65)', lineHeight: 2.0 }}>
          <div><b>W A S D</b> — Move around the garden</div>
          <div><b>Mouse</b> — Look around (FPS)</div>
          <div><b>Left Click</b> — Interact / Collect leaf</div>
          <div><b>Click Compost Bin</b> — Sell leaves for 🪙</div>
...
function OnboardingTip() {
  ...
  return (
    <div style={{
      ...
      color: '#3a2200', fontWeight: 800, fontSize: '17px',
...
function Scene() {
  ...
  // Register global bag pickup callback
  useEffect(() => {
